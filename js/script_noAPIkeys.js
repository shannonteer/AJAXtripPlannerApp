...
function loadData() {
    ...
    // load wunderground
    var wunderURL = 'http://api.wunderground.com/api/xxxxAPI-KEYxxxxx/conditions/almanac/q/' + stateStr + '/' + cityStr + '.json';
    ...
    // load nytimes
    var nytimesUrl = 'http://api.nytimes.com/svc/search/v2/articlesearch.json?q=' + cityStr + '&sort=newest&api-key=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';
